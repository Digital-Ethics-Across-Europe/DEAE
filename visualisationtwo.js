const allYears = {
    "2016": {
      ...
      "MT": { info: "Malta", numIncidents: 0 },
      "MD": { info: "Moldova", numIncidents: 16 },
      "NL": { info: "Netherlands", numIncidents: 10 },
      "MK": { info: "North Macedonia", numIncidents: 0 },
      "PL": { info: "Poland", numIncidents: 25 },
      "PT": { info: "Portugal", numIncidents: 0 },
      "RO": { info: "Romania", numIncidents: 0 },
      ...
      "BY": { info: "Belarus", numIncidents: 0 },
      "IS": { info: "Iceland", numIncidents: 0 },
      "AL": { info: "Albania", numIncidents: 0 },
      "BG": { info: "Bulgaria", numIncidents: 0 },
      "SI": { info: "Slovenia", numIncidents: 0 },
      "EE": { info: "Estonia", numIncidents: 0 },
      "LV": { info: "Latvia", numIncidents: 0 },
      "LI": { info: "Liechtenstein", numIncidents: 0 },
      "SK": { info: "Slovakia", numIncidents: 0 }
    },
    "2017": {
      "AM": { info: "Armenia", numIncidents: 13 },
      ...
      "CY": { info: "Cyprus", numIncidents: 0 },
      "FR": { info: "France", numIncidents: 0 },
      "IE": { info: "Ireland", numIncidents: 0 },
      "ME": { info: "Montenegro", numIncidents: 0 },
      "NO": { info: "Norway", numIncidents: 0 },
      "CH": { info: "Switzerland", numIncidents: 0 },
      "BY": { info: "Belarus", numIncidents: 0 },
      "IS": { info: "Iceland", numIncidents: 0 },
      "AL": { info: "Albania", numIncidents: 0 },
      "BG": { info: "Bulgaria", numIncidents: 0 },
    ...
    "2018":{
      ...
      "2022":{
        ...
        "MT": { info: "Malta", numIncidents: 0 },
        "MD": { info: "Moldova", numIncidents: 16 },
        "NL": { info: "Netherlands", numIncidents: 0 },
        "MK": { info: "North Macedonia", numIncidents: 0 },
...
function getColor(numIncidents) {
  if (numIncidents === undefined) return "#f5f3f4"; 

  const minIncidents = 1;
  const maxIncidents = 50; 
  const percentage = Math.min(numIncidents / maxIncidents, 1);
